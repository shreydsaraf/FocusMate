    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      >
        ...
        >
          ...
          {/* Center Column - Timer */}
          <div
            className={`flex flex-col items-center justify-center space-y-6 ${orientation === "landscape" && isMobile ? "lg:col-span-1" : ""}`}
          >
            {/* Character */}
            <motion.div
          ...
          <div className={`space-y-4 ${orientation === "landscape" && isMobile ? "lg:col-span-2" : ""}`}>
            {/* Stats */}
            <Card className={getCardClasses()}>
              <CardContent className={`${orientation === "landscape" && isMobile ? "p-3" : "p-4"}`}>
                <h3
